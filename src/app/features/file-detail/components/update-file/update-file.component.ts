...
import { FolderDetailService } from 'src/app/features/folder-detail/services/folder-detail.service';
...
@Component({
  ...
  providers: [FileDetailService,FolderDetailService],

})
export class UpdateFileComponent
implements OnInit {
  private readonly bottomSheet = inject(MatBottomSheetRef<UpdateFileComponent>);
  ...
  _tableName :  any = inject(MAT_BOTTOM_SHEET_DATA);
  tableN:string ;
  ...
  public ngOnInit(): void {
    ...
    this.tableN = this._tableName.tableName
...
private customFieldValidator: ValidatorFn = (control: AbstractControl): { [key: string]: any } | null => {
  ...
  public close(): void {
    this.bottomSheet.dismiss(this.dataFile);
  }
  ...
  public uploadFile(): void {
    ...
    uploadedFile.append('table_name', this.tableN);
    uploadedFile.append('write_disposition', formValue.write_disposition);
